...
return [
    ...
    | göstermek için gereken çeşitli mesajlar için kullanılır. Uygulamanızın
    | gereksinimlerine göre bu dil satırlarını değiştirme özgürlüğüne sahipsiniz.
    |
    */
    ...
    'invalid_credentials' => 'Girilen E-posta veya parola yanlış'
