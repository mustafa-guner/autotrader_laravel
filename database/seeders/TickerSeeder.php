        ...
        foreach ($tickers as $ticker) {
            ...
            Ticker::firstOrCreate(
                ...
                [
                    ...
                    'logo_url' => isset($details['branding']['logo_url']) ? $details['branding']['logo_url'] . '?apiKey=' . config('services.polygon.api_key') : null,
                    'icon_url' => isset($details['branding']['icon_url']) ? $details['branding']['icon_url'] . '?apiKey=' . config('services.polygon.api_key') : null,
